...
Some participants just can't get enough of ice-skating and are participating multiple times in the event. The event is held 3 or 4 times in a period of 10 days and I am curious who finished at least 3 times in the full distance and what their times were.

```{r echo=FALSE, message=FALSE, warning=FALSE, Triple}
plotWeissenseeTriple = function(year, yearLabels){
  weissensee_triple <- c()
